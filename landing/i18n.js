...
const I18N = {
  ...
  en: {
    ...
    // --- Hero ---
    "hero.badge": "v1.0.2-beta — Open Source & Free Forever",
  ...
  hi: {
    ...
    "hero.badge": "v1.0.2-beta — ओपन सोर्स, हमेशा मुफ़्त",
  ...
  ta: {
    ...
    "hero.badge": "v1.0.2-beta — திறந்த மூலம், எப்போதும் இலவசம்",
  ...
  te: {
    ...
    "hero.badge": "v1.0.2-beta — ఓపెన్ సోర్స్, ఎల్లప్పుడూ ఉచితం",
  ...
  bn: {
    ...
    "hero.badge": "v1.0.2-beta — ওপেন সোর্স, চিরকাল বিনামূল্যে",
  ...
  mr: {
    ...
    "hero.badge": "v1.0.2-beta — ओपन सोर्स, कायम मोफत",
  ...
  /* ═══════════════════════ GUJARATI ═══════════════════════ */
  gu: {
    "hero.badge": "v1.0.2-beta — ઓપન સોર્સ, હંમેશા મફત",
  ...
  /* ═══════════════════════ KANNADA ═══════════════════════ */
  kn: {
    "hero.badge": "v1.0.2-beta — ಮುಕ್ತ ಮೂಲ, ಶಾಶ್ವತ ಉಚಿತ",
  ...
  /* ═══════════════════════ MALAYALAM ═══════════════════════ */
  ml: {
    "hero.badge": "v1.0.2-beta — ഓപ്പൺ സോഴ്സ്, என்றும் സൗജன്യം",
  ...
  /* ═══════════════════════ PUNJABI ═══════════════════════ */
  pa: {
    "hero.badge": "v1.0.2-beta — ਓਪਨ ਸੋਰਸ, ਹਮੇਸ਼ਾ ਮੁਫ਼ਤ",
