  ...
  if (!releaseExists) {
    container.innerHTML = `
      <div class="col-span-full text-center py-12 px-6 rounded-2xl border border-brand-500/20 bg-brand-500/5">
        ...
        <p class="text-gray-400 mb-6 max-w-md mx-auto">CodeIn v1.0.0 is available now. Get the latest release from GitHub.</p>
...
function updateHeroForOS() {
  ...
  if (releaseExists) {
    ...
    if (osLabel) osLabel.textContent = "v1.0.0 — Available Now";
