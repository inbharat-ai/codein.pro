...
import { ICodeinServerClient } from "../../codeinServer/interface";
...
export const testCodeinServerClient = {
  connected: false,
  getFromIndexCache: jest.fn(),
} as unknown as ICodeinServerClient;

const mockCodeinServerClient = {
  connected: false,
  getFromIndexCache: jest.fn(),
} as unknown as ICodeinServerClient;
